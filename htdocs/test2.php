		...
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						...
						<div class="section_title"><h1>本郷亭名駅店</h1></div>
					</div>
				</div>
			</div>
			...
			<div class="row themenu_row">
				...
				<div class="col-lg-4 themenu_column">
					<div class="themenu_image"><img src="images/H3.png" alt=""></div>
					<div class="themenu_col trans_400">
						<div class="themenu_col_title">四川ラーメン</div>
						<div class="dish_list">
							...
							<div class="dish">
								<div class="dish_title_container d-flex flex-xl-row flex-column align-items-start justify-content-start">
									<div class="dish_title">チャーシュー少なめ</div>
									<div class="dish_price">¥780</div>
								</div>
								<div class="dish_contents">
									<ul class="d-flex flex-row align-items-start justify-content-start flex-wrap">
									</ul>
							...
							<div class="dish">
								<div class="dish_title_container d-flex flex-xl-row flex-column align-items-start justify-content-start">
									<div class="dish_title">チャーシュー麵</div>
									<div class="dish_price">¥1350</div>
								</div>
								<div class="dish_contents">
									<ul class="d-flex flex-row align-items-start justify-content-start flex-wrap">
									</ul>
							...
							<div class="dish">
								<div class="dish_title_container d-flex flex-xl-row flex-column align-items-start justify-content-start">
									<div class="dish_title">大盛りチャーシュー麵</div>
									<div class="dish_price">¥1500</div>
								</div>
								<div class="dish_contents">
									<ul class="d-flex flex-row align-items-start justify-content-start flex-wrap">
									</ul>
				...
				<!-- 2 -->
				<div class="col-lg-4 themenu_column">
					<div class="themenu_image"><img src="images/H4.png" alt=""></div>
					<div class="themenu_col trans_400">
						<div class="themenu_col_title">白湯ラーメン</div>
						<div class="dish_list">
				...
				<!-- 3 -->
				<div class="col-lg-4 themenu_column">
					<div class="themenu_image"><img src="images/H5.png" alt=""></div>
					<div class="themenu_col trans_400">
						<div class="themenu_col_title">醬油ラーメン</div>
						<div class="dish_list">
