			...
			<div class="row">
				<div class="col">
					<div class="header_content d-flex flex-row align-items-center justify-content-start">
						...
						<?php
					if ( $user_login ){
						echo "<div class='reservations_phone ml-auto'>$_SESSION[name].さま";
									}
						?>
					</div>
				</div>
...
<div class="container-login100" style="background-image: url('images/home.jpg');">
  <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
    <form method='post' action="/RegisterAction.php" class="login100-form validate-form">
      <span class="login100-form-title p-b-49">
        会員登録
      </span>
      <div class="wrap-input100 validate-input m-b-23" data-validate = "Name is reauired">
        <span class="label-input100">Name(20字以内)</span>
        <input class="input100" type="text" name="name" placeholder="お名前を入力してください">
        <span class="focus-input100" data-symbol="&#xf206;"></span>
      </div>

      <div class="wrap-input100 validate-input m-b-23" data-validate = "ID is reauired">
        <span class="label-input100">ID(20字以内)</span>
      ...
      <div class="wrap-input100 validate-input" data-validate="Password is required">
        <span class="label-input100">Password(20字以内)</span>
        <input class="input100" type="password" name="password" placeholder="パスワードを入力してください">
        <span class="focus-input100" data-symbol="&#xf190;"></span>
      </div>

        <div class="wrap-input100 validate-input" data-validate="Passwordcheck is required">
        <span class="label-input100">Password Check</span>
        <input class="input100" type="password" name="passwordcheck" placeholder="パスワードをもう一度入力してください">
        <span class="focus-input100" data-symbol="&#xf190;"></span>
      </div>

      <div class="wrap-input100 validate-input" data-validate="Email is required">
        <span class="label-input100">Email(50字以内)</span>
        <input class="input100" type="email" name="email" placeholder="Emailを入力してください">
        <span class="focus-input100" data-symbol="&#xf2bb;"></span>
      </div>

      <div class="wrap-input100 validate-input" data-validate="Email is required">
        <span class="label-input100">phone number</span>
        <input class="input100" type="telephone number" name="phone" placeholder="電話番号を入力してください">
        <span class="focus-input100" data-symbol="&#xf2bb;"></span>
      </div>

      <div class="wrap-input100 validate-input" data-validate="Gender is required">
        <span class="label-input100">Gender</span>
        男性<input type="radio" name="gender" value="男性"> 女性<input type="radio" name="gender" value="女性">
